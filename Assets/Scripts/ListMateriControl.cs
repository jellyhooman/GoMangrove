...
public class ListMateriControl : MonoBehaviour
{
    ...
    IEnumerator Start()
    {
        ...
        if (www.error == null)
        {
            ...
            for (int i = 1; i < arrSize; i++)
            {
                ...
                string tdata = examplessss.usersMurid[i].username;
    ...
    public void OnButtonClick(string tdata)
    {
        Debug.Log(tdata);
        PlayerPrefs.SetString("id", tdata);
        Application.LoadLevel("HasilTest");
    }
